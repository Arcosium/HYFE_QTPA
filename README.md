...
데이터 창은 2023-01~2026-05 이고 폴드와 홀드아웃 모두 학습 종료 뒤 1~3개월을 잰다.
...
실전 운용은 분기 재학습을 전제로 한다. 이미지(`heatf`, 96×180 그레이스케일) = 창 안 OHLC 로그비·거래량·30일 대비
...
논문 그림·표·조립 스크립트는 `paper/`(원고 docx·PDF 는 팀장 공유). 서사 초안은 `논문초안.md`.
